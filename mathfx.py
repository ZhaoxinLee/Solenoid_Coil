...
def impedanceCompensationFirstOrder(freq, cutoffFreq):
    """ Compensate for increased impedance of a first order
        system for sinusoidal inputs at higher frequencies """
    # Note: the units of freq and cutoffFreq can be rad/s or Hz
    # as long as both variables share the same units
    compensationFactor = sqrt((freq/cutoffFreq)**2 + 1)
